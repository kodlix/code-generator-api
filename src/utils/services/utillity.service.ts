...
export class UtilityService {
  ...
  static generateUniqueAccountCode(businessName: string): string {
    return businessName.substring(0, 3).toUpperCase() + "_" + this.generateRandomInteger(10000, 99999).toString();
  }
